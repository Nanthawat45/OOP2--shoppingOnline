...
const main = () => {
  ...
  // สร้างบัญชีผู้ใช้
  const account1 = new Account("Tin", "BanTin", false, "05/01/2567", "");

  // สร้างสินค้า
  const Product1 = new Product("1", "ปากกา", "Bell");
  const Product2 = new Product("2", "ดินสอ", "Jane");
  const Product3 = new Product("3", "ยางลบ", "Nj");
  const Product4 = new Product("4", "ไม้บรรทัด", "Mind");
  const Product5 = new Product("5", "กล่องดินสอ", "Aon");
